...
/*Modified by Kelsey Reiman, Athena Kihara, and Sasha Levy. We changed the 
tepmeratures that control the lights in order to suit our needs. */
...
int groundPin2 = 18;    //setting 17 to be another - (ground) pin
...
//***************
//We modified the temperature settings 
if (temperatureF < 80) { // above 12C the light goes off
Serial.print(temperatureF);
Serial.println("degrees F temperature GREATER THAN 80");
...
else if (temperatureF > 80) { //below 12C and above or equal to 1C, the lights fade in and out
 
// set the brightness of all five LEDS:
Serial.print(temperatureF);
Serial.println("degrees F temperature LESS THAN 80");
